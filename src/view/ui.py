...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.ioTab)
        ...
        self.rendererSelectCombo = QtWidgets.QComboBox(parent=self.widget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rendererSelectCombo.sizePolicy().hasHeightForWidth())
        self.rendererSelectCombo.setSizePolicy(sizePolicy)
        self.rendererSelectCombo.setObjectName("rendererSelectCombo")
        self.horizontalLayout_8.addWidget(self.rendererSelectCombo)
        self.rendererRenderBtn = QtWidgets.QPushButton(parent=self.widget_5)
        self.rendererRenderBtn.setObjectName("rendererRenderBtn")
        self.horizontalLayout_8.addWidget(self.rendererRenderBtn)
        self.rendererSettingBtn = QtWidgets.QPushButton(parent=self.widget_5)
        self.rendererSettingBtn.setObjectName("rendererSettingBtn")
        self.horizontalLayout_8.addWidget(self.rendererSettingBtn)
        self.verticalLayout_11.addWidget(self.widget_5)
        self.rendererProgressbar = QtWidgets.QProgressBar(parent=self.groupBox_3)
        self.rendererProgressbar.setProperty("value", 24)
        self.rendererProgressbar.setObjectName("rendererProgressbar")
        self.verticalLayout_11.addWidget(self.rendererProgressbar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Renderer"))
        self.rendererRenderBtn.setText(_translate("MainWindow", "Render"))
        self.rendererSettingBtn.setText(_translate("MainWindow", "Setting"))
