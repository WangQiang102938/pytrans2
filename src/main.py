...
class PyTransApp:
    ...
    def debug_call(self):
        ...
        ins['Google Translate'].link_info['in:[[str]]']=(ins["StdFormatter"],'out:[[str]]')
        ins["HTML Gen V1"].link_info['image_in:Image']=(ins["Standard Crop"],'Image out')
        ins["HTML Gen V1"].link_info['translated_in:[[str]]']=(ins["Google Translate"],'out:[[str]]')
